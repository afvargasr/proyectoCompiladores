...
fun main() {
    ...
    var codigoFuente = "fun principal():float {var int aux = 1;}fun suma(int aux):int {cons string a = aux; while( 1 < 2 ) {a++;} b++; }fun restar(int aux):int {cons string cadena = #hola#;suma(1);}"
